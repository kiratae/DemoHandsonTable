 ...
 */
import { CellType, CellValueType, SimpleCellAddress } from './Cell';
...
export declare class HyperFormula implements TypedEmitter {
     ...
     * @category Cells
     */
    getCellSerialized(cellAddress: SimpleCellAddress): NoErrorCellValue;
    /**
     ...
     * @category Sheets
     */
    getSheetSerialized(sheetId: number): NoErrorCellValue[][];
    /**
     ...
     * @category Ranges
     */
    getRangeSerialized(leftCorner: SimpleCellAddress, width: number, height: number): CellValue[][];
    /**
