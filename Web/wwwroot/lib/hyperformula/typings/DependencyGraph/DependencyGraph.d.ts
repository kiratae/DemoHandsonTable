...
export declare class DependencyGraph {
    ...
    setValueToCell(address: SimpleCellAddress, newValue: ValueCellVertexValue): void;
    ...
    valuesFromRange(range: AbsoluteCellRange): IterableIterator<[InternalScalarValue, SimpleCellAddress]>;
    ...
    dependencyQuery: (vertex: Vertex) => Set<Vertex> | null;
