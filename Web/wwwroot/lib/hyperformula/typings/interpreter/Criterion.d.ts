...
export declare class CriterionBuilder {
    ...
    fromCellValue(raw: InternalScalarValue, arithmeticHelper: ArithmeticHelper): Maybe<CriterionPackage>;
    parseCriterion(criterion: InternalScalarValue, arithmeticHelper: ArithmeticHelper): Maybe<Criterion>;
}
export declare type CriterionPackage = {
    raw: string | number | boolean;
    lambda: CriterionLambda;
};
export declare type CriterionLambda = (cellValue: InternalScalarValue) => boolean;
