        ...
        case AstNodeType.TIMES_OP:
          {
            ...
            return (_j = this.passErrors(_leftResult8, _rightResult8)) !== null && _j !== void 0 ? _j : multiply(this.arithmeticHelper.coerceScalarToNumberOrError(_leftResult8), this.arithmeticHelper.coerceScalarToNumberOrError(_rightResult8));
          }
        ...
        case AstNodeType.POWER_OP:
          {
            ...
            return (_k = this.passErrors(_leftResult9, _rightResult9)) !== null && _k !== void 0 ? _k : power(this.arithmeticHelper.coerceScalarToNumberOrError(_leftResult9), this.arithmeticHelper.coerceScalarToNumberOrError(_rightResult9));
          }
        ...
        case AstNodeType.DIV_OP:
          {
            ...
            return (_l = this.passErrors(_leftResult10, _rightResult10)) !== null && _l !== void 0 ? _l : divide(this.arithmeticHelper.coerceScalarToNumberOrError(_leftResult10), this.arithmeticHelper.coerceScalarToNumberOrError(_rightResult10));
          }
        ...
        case AstNodeType.MINUS_UNARY_OP:
          {
            ...
            if (_result instanceof SimpleRangeValue) {
              ...
              return unaryminus(this.arithmeticHelper.coerceScalarToNumberOrError(_result));
            }
          }
        ...
        case AstNodeType.PERCENT_OP:
          {
            ...
            if (_result2 instanceof SimpleRangeValue) {
              ...
              return percent(this.arithmeticHelper.coerceScalarToNumberOrError(_result2));
            }
          }
